	...
	.text
.Ltext0:
	.file 0 "E://Works//ElectronicAsso//2022//Oct//15th" "E:/Works/ElectronicAsso/2022/Oct/15th/on.c"
...
.LFE8:
	...
	.section .rdata,"dr"
.LC0:
	.ascii "pls input the 3*2 matrix a:\12\0"
.LC1:
	.ascii "%d\0"
.LC2:
	.ascii "pls input the 2*3 matrix b:\12\0"
.LC3:
	.ascii "The product of a and b is:\12\0"
.LC4:
	.ascii "%d \0"
.LC5:
	.ascii "\12\0"
...
main:
.LFB44:
	.file 2 "E:/Works/ElectronicAsso/2022/Oct/15th/on.c"
	.loc 2 21 11
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI12:
...
.L17:
	...
	.loc 2 44 32 discriminator 3
	imull	%ecx, %eax
	.loc 2 44 21 discriminator 3
	addl	%eax, -28(%rbp)
	.loc 2 43 13 discriminator 3
	addl	$1, -32(%rbp)
.L16:
	.loc 2 43 31 discriminator 1
	cmpl	$1, -32(%rbp)
	jle	.L17
.LBE12:
	.loc 2 46 19
...
.LASF0:
	.ascii "E:\\Works\\ElectronicAsso\\2022\\Oct\\15th\\on.c\0"
