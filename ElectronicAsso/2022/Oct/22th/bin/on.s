	...
	.text
.Ltext0:
	.file 0 "E://Works//ElectronicAsso//2022//Oct//22th" "E:/Works/ElectronicAsso/2022/Oct/22th/on.c"
...
.LFE8:
	.seh_endproc
	.text
	.globl	_Z11Bubble_SortPi
	.def	_Z11Bubble_SortPi;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z11Bubble_SortPi
_Z11Bubble_SortPi:
.LFB80:
	.file 2 "E:/Works/ElectronicAsso/2022/Oct/22th/on.c"
	.loc 2 15 1
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI12:
...
.LBE6:
.LBE5:
	.loc 2 18 9 discriminator 2
	addl	$1, -8(%rbp)
.L7:
	.loc 2 18 31 discriminator 1
	movl	$9, %eax
	subl	-4(%rbp), %eax
	.loc 2 18 27 discriminator 1
	cmpl	%eax, -8(%rbp)
	jl	.L9
.LBE4:
.LBE3:
	.loc 2 16 5 discriminator 2
	addl	$1, -4(%rbp)
.L6:
	.loc 2 16 23 discriminator 1
	cmpl	$8, -4(%rbp)
	jle	.L10
.LBE2:
	.loc 2 28 1
...
.LFE80:
	...
	.section .rdata,"dr"
.LC0:
	.ascii "pls input 10 intergers: \0"
.LC1:
	.ascii "%d\0"
.LC2:
	.ascii "the sorted array is:\11\0"
.LC3:
	.ascii "%d \0"
	.text
	.globl	main
...
.LBB8:
	...
	jmp	.L12
.L13:
	.loc 2 37 25 discriminator 3
	movl	-4(%rbp), %eax
	cltq
	.loc 2 37 23 discriminator 3
	leaq	0(,%rax,4), %rdx
...
.LBB9:
	...
	jmp	.L14
.L15:
	.loc 2 46 29 discriminator 3
	movl	-8(%rbp), %eax
	cltq
	.loc 2 46 27 discriminator 3
	leaq	0(,%rax,4), %rdx
	movq	-16(%rbp), %rax
	addq	%rdx, %rax
	.loc 2 46 15 discriminator 3
	movl	(%rax), %eax
	movl	%eax, %edx
	leaq	.LC3(%rip), %rax
	movq	%rax, %rcx
	call	_Z6printfPKcz
	.loc 2 44 5 discriminator 3
	addl	$1, -8(%rbp)
.L14:
	.loc 2 44 23 discriminator 1
	cmpl	$9, -8(%rbp)
	jle	.L15
.LBE9:
	.loc 2 48 12
...
.LASF0:
	.ascii "E:\\Works\\ElectronicAsso\\2022\\Oct\\22th\\on.c\0"
.LASF1:
