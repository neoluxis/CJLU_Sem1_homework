	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//2022//Opt//work4" "E:/Works/Clang/2022/Opt/work4/5.c"
...
main:
.LFB44:
	.file 2 "E:/Works/Clang/2022/Opt/work4/5.c"
	.loc 2 15 1
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI6:
...
.L8:
	...
	movl	$-1, -96(%rbp,%rax,4)
.L7:
	.loc 2 23 9 discriminator 2
	addl	$1, 232(%rbp)
.L5:
	.loc 2 23 23 discriminator 1
	cmpl	$8, 232(%rbp)
	jle	.L9
...
.LASF0:
	.ascii "E:\\Works\\Clang\\2022\\Opt\\work4\\5.c\0"
