	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//2022//Opt//work6" "E:/Works/Clang/2022/Opt/work6/7.c"
...
_Z1fi:
.LFB80:
	.file 2 "E:/Works/Clang/2022/Opt/work6/7.c"
	.loc 2 17 14
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI12:
...
.LFE80:
	.seh_endproc
	.globl	_Z10bubbleSortPij
	.def	_Z10bubbleSortPij;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z10bubbleSortPij
_Z10bubbleSortPij:
.LFB81:
	.loc 2 23 37
	pushq	%rbp
...
.L11:
	...
	movl	%eax, (%rdx)
.L10:
	.loc 2 26 9 discriminator 2
	addl	$1, -8(%rbp)
.L9:
	.loc 2 26 36 discriminator 1
	movl	-4(%rbp), %eax
	.loc 2 26 34 discriminator 1
	movl	24(%rbp), %edx
	subl	%eax, %edx
	.loc 2 26 38 discriminator 1
	leal	-1(%rdx), %eax
	.loc 2 26 25 discriminator 1
	movl	-8(%rbp), %edx
...
.LBE3:
	...
	addl	$1, -4(%rbp)
.L8:
	.loc 2 25 21 discriminator 1
	movl	-4(%rbp), %eax
	.loc 2 25 23 discriminator 1
	cmpl	24(%rbp), %eax
	jb	.L12
.LBE2:
	.loc 2 34 1
...
.LFE81:
	...
	.align 8
.LC0:
	.ascii "Please enter the number of elements: \0"
.LC1:
	.ascii "%d\0"
.LC2:
	.ascii "Please enter the elements: \0"
.LC3:
	.ascii "%d \0"
.LC4:
	.ascii "\12\0"
...
.L15:
	...
	addl	$1, -4(%rbp)
.L14:
	.loc 2 46 21 discriminator 1
	movl	-4(%rbp), %edx
	.loc 2 46 23 discriminator 1
	movl	-20(%rbp), %eax
	cmpl	%eax, %edx
	jb	.L15
.LBE5:
...
.L17:
	...
	addl	$1, -8(%rbp)
.L16:
	.loc 2 54 21 discriminator 1
	movl	-8(%rbp), %edx
	.loc 2 54 23 discriminator 1
	movl	-20(%rbp), %eax
	cmpl	%eax, %edx
	jb	.L17
.LBE6:
...
.Letext0:
	...
	.file 10 "E:/Works/Clang/2022/Opt/work6/util.h"
...
.LASF0:
	.ascii "E:\\Works\\Clang\\2022\\Opt\\work6\\7.c\0"
