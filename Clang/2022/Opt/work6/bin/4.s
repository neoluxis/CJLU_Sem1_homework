	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//2022//Opt//work6" "E:/Works/Clang/2022/Opt/work6/4.c"
...
_Z7isPrimei:
.LFB44:
	.file 2 "E:/Works/Clang/2022/Opt/work6/4.c"
	.loc 2 19 23
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI6:
...
.L13:
	...
	call	_Z6printfPKcz
.L14:
	.loc 2 35 5 discriminator 2
	addl	$1, -4(%rbp)
.L12:
	.loc 2 35 18 discriminator 1
	cmpl	$100, -4(%rbp)
	jle	.L15
.LBE3:
	.loc 2 55 12
...
.LASF0:
	.ascii "E:\\Works\\Clang\\2022\\Opt\\work6\\4.c\0"
