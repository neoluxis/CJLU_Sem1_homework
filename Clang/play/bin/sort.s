	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//play" "E:/Works/Clang/play/sort.c"
...
main:
.LFB44:
	.file 2 "E:/Works/Clang/play/sort.c"
	.loc 2 4 1
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI6:
...
.L7:
	...
	movl	%edx, -64(%rbp,%rax,4)
.L6:
	.loc 2 10 9 discriminator 2
	addl	$1, -8(%rbp)
.L5:
	.loc 2 10 27 discriminator 1
	cmpl	$9, -8(%rbp)
	jle	.L7
	.loc 2 8 5 discriminator 2
	addl	$1, -4(%rbp)
.L4:
	.loc 2 8 19 discriminator 1
	cmpl	$9, -4(%rbp)
	jle	.L8
	.loc 2 20 12
	movl	$0, -4(%rbp)
...
.LASF0:
	.ascii "E:\\Works\\Clang\\play\\sort.c\0"
