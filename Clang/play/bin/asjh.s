	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//play" "E:/Works/Clang/play/asjh.c"
...
.LFE8:
	...
	.section .rdata,"dr"
.LC0:
	.ascii "\350\257\267\350\276\223\345\205\245\350\257\255\345\217\245: \0"
	.text
	.globl	main
...
main:
.LFB44:
	.file 2 "E:/Works/Clang/play/asjh.c"
	.loc 2 3 1
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI6:
...
.L5:
	...
	testb	%al, %al
	je	.L10
	.loc 2 10 5 discriminator 2
	addl	$1, -4(%rbp)
.L4:
	.loc 2 10 23 discriminator 1
	cmpl	$80, -4(%rbp)
	jle	.L8
	jmp	.L7
.L10:
...
.LASF0:
	.ascii "E:\\Works\\Clang\\play\\asjh.c\0"
.LASF1:
