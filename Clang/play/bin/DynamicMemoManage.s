	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//play" "E:/Works/Clang/play/DynamicMemoManage.c"
...
_Z1fi:
.LFB80:
	.file 2 "E:/Works/Clang/play/DynamicMemoManage.c"
	.loc 2 14 14
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI12:
...
.LBB2:
	...
	jmp	.L8
.L9:
	.loc 2 27 13 discriminator 3
	movl	-4(%rbp), %eax
	cltq
	.loc 2 27 14 discriminator 3
	leaq	0(,%rax,4), %rdx
	movq	-16(%rbp), %rax
	addq	%rax, %rdx
	.loc 2 27 16 discriminator 3
	movl	-4(%rbp), %eax
	movl	%eax, (%rdx)
	.loc 2 26 5 discriminator 3
	addl	$1, -4(%rbp)
.L8:
	.loc 2 26 18 discriminator 1
	movl	-20(%rbp), %eax
	cmpl	%eax, -4(%rbp)
	jl	.L9
.LBE2:
...
.LASF0:
	.ascii "E:\\Works\\Clang\\play\\DynamicMemoManage.c\0"
.LASF1:
