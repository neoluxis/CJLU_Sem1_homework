	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//InClass//Class1" "E:/Works/Clang/InClass/Class1/3.3.c"
...
main:
.LFB44:
	.file 2 "E:/Works/Clang/InClass/Class1/3.3.c"
	.loc 2 6 1
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI12:
...
.LFE44:
	...
	.section .rdata,"dr"
.LC3:
	.ascii "Invalid month\0"
	.text
	.globl	_Z9checkDaysii
	.def	_Z9checkDaysii;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z9checkDaysii
_Z9checkDaysii:
.LFB45:
	.loc 2 14 1
	pushq	%rbp
...
.L20:
	...
	movl	%edx, %eax
	subl	%ecx, %eax
	.loc 2 22 25 discriminator 1
	testl	%eax, %eax
	jne	.L24
.L23:
	.loc 2 22 48 discriminator 3
	movl	16(%rbp), %edx
	movslq	%edx, %rax
	imulq	$1374389535, %rax, %rax
	shrq	$32, %rax
...
.LASF0:
	.ascii "E:\\Works\\Clang\\InClass\\Class1\\3.3.c\0"
