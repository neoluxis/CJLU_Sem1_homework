	...
	.text
.Ltext0:
	.file 0 "E://Works//Clang//exper" "E:/Works/Clang/exper/scores.c"
...
.LC1:
	.ascii "scores.txt\0"
.LC2:
	.ascii "Can't open file %s\12\0"
.LC3:
	.ascii "%d\0"
	.align 8
.LC4:
	.ascii "The total number of students is %d\12\0"
.LC5:
	.ascii "The highest score is %d\12\0"
.LC6:
	.ascii "The lowest score is %d\12\0"
.LC7:
	.ascii "The average score is %f\12\0"
	.align 8
.LC8:
	.ascii "The number of students who failed is %d\12\0"
	.text
	.globl	main
...
main:
.LFB94:
	.file 2 "E:/Works/Clang/exper/scores.c"
	.loc 2 15 1
	pushq	%rbp
	.seh_pushreg	%rbp
.LCFI9:
...
.LASF0:
	.ascii "E:\\Works\\Clang\\exper\\scores.c\0"
.LASF1:
